...
void CardOne::ReadCardParameters(Grid * pGrid)
{
	...
	pOut->PrintMessage("Enter Wallet Amount to Decrement... ");
...
void CardOne::Apply(Grid* pGrid, Player* pPlayer)
{
	...
	newWalletAmount = pPlayer->GetWallet() - walletAmount;
	pPlayer->SetWallet(newWalletAmount);


}

Card* CardOne::Copy(Card* pCard) {
	CellPosition pos;
	CardOne* copy = new CardOne(pos);
